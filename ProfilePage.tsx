        ...
        <main className="container mx-auto px-4 py-8">
            ...
            <div className="max-w-4xl mx-auto space-y-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <GlassmorphicCard className="p-8 flex items-center space-x-6 md:col-span-2">
                        <img
                            src={user.avatarUrl}
                            alt="User Avatar"
                    ...
                    <GlassmorphicCard className="p-6 text-center flex flex-col justify-center">
                        <p className="text-slate-300 mb-2">Lifetime Savings</p>
                        <p className={`text-4xl font-bold text-green-400`}>₹{lifetimeSavings}</p>
